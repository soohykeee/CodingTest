...
"명예의 전당"이라는 TV 프로그램에서는 매일 1명의 가수가 노래를 부르고, 시
청자들의 문자 투표수로 가수에게 점수를 부여합니다.
...
public class 명예의전당1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(3, new int[]{10, 100, 20, 150, 1, 100, 200}));
        System.out.println(T.solution(4, new int[]{0, 300, 40, 300, 20, 70, 150, 50, 500, 1000}));
